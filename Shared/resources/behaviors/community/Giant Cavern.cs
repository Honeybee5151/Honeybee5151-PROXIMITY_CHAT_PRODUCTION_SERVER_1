        ...
        public static void Register(BehaviorDb db)
        {
            ...
            db.RegisterCommunity("Greg",
                new State(
                    ...
                    new State("enrage_land",
                        ...
                        new NewExpandingRing(maxRadius: 12f, expandDuration: 2f, ringThickness: 1.5f, damage: 200, color: 0xFFFF2200, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
                    ...
                    new State("enrage_land_loop",
                        new SetAltTexture(0),
                        new Flash(0xFF0000, 0.5, 3),
                        new NewExpandingRing(maxRadius: 15f, expandDuration: 2f, ringThickness: 1.5f, damage: 200, color: 0xFFFF2200, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
                        new TimedTransition(0, "enrage_chase"),
                        new HpLessTransition(0.15, "enrage_desperation_jump")
                    ),
                    ...
                    new State("enrage_desperation_land",
                        ...
                        new NewExpandingRing(maxRadius: 10f, expandDuration: 1.5f, ringThickness: 2f, damage: 200, color: 0xFFFF0000, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
                        new NewExpandingRing(maxRadius: 18f, expandDuration: 3f, ringThickness: 2f, damage: 200, color: 0xFFFF2200, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
            ...
            db.RegisterCommunity("Brog",
                new State(
                    ...
                    new State("land1",
                        new SetAltTexture(0),
                        new NewExpandingRing(maxRadius: 15f, expandDuration: 3f, ringThickness: 1.5f, damage: 200, color: 0xFFFF4400, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
                    ...
                    new State("land2",
                        new SetAltTexture(0),
                        new NewExpandingRing(maxRadius: 18f, expandDuration: 3f, ringThickness: 1.5f, damage: 200, color: 0xFFFF4400, effect: ConditionEffectIndex.Slowed, effectDuration: 6000),
            ...
            db.RegisterCommunity("Boss Giant",
                new State(
                    ...
                    new State("waiting",
                        new State("w_f0", new SetAltTexture(0), new TimedTransition(300, "w_f1")),
                        new State("w_f1", new SetAltTexture(1), new TimedTransition(300, "w_f2")),
                        new State("w_f2", new SetAltTexture(2), new TimedTransition(300, "w_f3")),
                        new State("w_f3", new SetAltTexture(3), new TimedTransition(300, "w_f4")),
                        new State("w_f4", new SetAltTexture(4), new TimedTransition(300, "w_f0")),
                        new QuestTextActiveTransition("idle", "Talk to Boss Giant")
                    ),
                    new State("idle",
                        new State("i_f0", new SetAltTexture(0), new TimedTransition(300, "i_f1")),
                        new State("i_f1", new SetAltTexture(1), new TimedTransition(300, "i_f2")),
                        new State("i_f2", new SetAltTexture(2), new TimedTransition(300, "i_f3")),
                        new State("i_f3", new SetAltTexture(3), new TimedTransition(300, "i_f4")),
                        new State("i_f4", new SetAltTexture(4), new TimedTransition(300, "i_f0")),
                        new NpcDialogue(
            ...
            // ========== DWARFISM GIANT (third boss — spawned by dialogue) ==========
            // Behaviors commented out for now — just testing sprite phase transitions
