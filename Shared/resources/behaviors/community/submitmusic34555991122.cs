...
{
    public static class Behavior_submitmusic34555991122
    {
        public static void Register(BehaviorDb db)
        {
            db.RegisterCommunity("submitmusic34555991122 Frostscale Wyrm",
    new State(
        new State("idle",
            new Prioritize(
    ...
    new Threshold(0.01,
        new ItemLoot("submitmusic34555991122 Emberbrand", 0.04)
    )
);
        }
    }
